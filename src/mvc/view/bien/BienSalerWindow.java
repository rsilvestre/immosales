...
public class BienSalerWindow extends JDialog {
	...
	public Bien.BienStatus getBienStatus() {
		return Bien.BienStatus.fromString((String) cStatus.getSelectedItem());
	}
