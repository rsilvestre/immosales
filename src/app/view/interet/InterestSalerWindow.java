...
public class InterestSalerWindow extends JDialog {
	...
	protected void setDefaultValue(Interest interest) {
		...
		tBuyer.setText(interest.getBuyer().toString());
...
// DO NOT EDIT OR ADD ANY CODE HERE!
	...
	private void $$$setupUI$$$() {
		...
		panel1 = new JPanel();
		panel1.setLayout(new FormLayout("fill:168px:grow,left:4dlu:noGrow,fill:325px:grow", "center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:72px:noGrow,top:3dlu:noGrow,center:94px:noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow,top:3dlu:noGrow,center:max(d;4px):noGrow"));
		...
		panel1.add(tOwner, cc.xy(3, 5, CellConstraints.FILL, CellConstraints.DEFAULT));
		final JLabel label3 = new JLabel();
		label3.setText("Nom du bien");
		panel1.add(label3, cc.xy(1, 9));
		tName = new JTextField();
		tName.setEditable(false);
		panel1.add(tName, cc.xy(3, 9, CellConstraints.FILL, CellConstraints.DEFAULT));
		...
		panel1.add(scrollPane2, cc.xy(3, 13, CellConstraints.FILL, CellConstraints.FILL));
		...
		panel1.add(tPrice, cc.xy(3, 15, CellConstraints.FILL, CellConstraints.DEFAULT));
		final JLabel label7 = new JLabel();
		label7.setText("Année de construction");
		panel1.add(label7, cc.xy(1, 17));
		final JLabel label8 = new JLabel();
		label8.setText("Taille de la façade");
		panel1.add(label8, cc.xy(1, 19));
		final JLabel label9 = new JLabel();
		label9.setText("Nombre de façade");
		panel1.add(label9, cc.xy(1, 21));
		final JLabel label10 = new JLabel();
		label10.setText("Nombre d'étage");
		panel1.add(label10, cc.xy(1, 23));
		final JLabel label11 = new JLabel();
		label11.setText("CPEB");
		panel1.add(label11, cc.xy(1, 25));
		tYearConstruction = new JTextField();
		tYearConstruction.setEditable(false);
		panel1.add(tYearConstruction, cc.xy(3, 17, CellConstraints.FILL, CellConstraints.DEFAULT));
		tFaceWide = new JTextField();
		tFaceWide.setEditable(false);
		panel1.add(tFaceWide, cc.xy(3, 19, CellConstraints.FILL, CellConstraints.DEFAULT));
		tFaceNumber = new JTextField();
		tFaceNumber.setEditable(false);
		panel1.add(tFaceNumber, cc.xy(3, 21, CellConstraints.FILL, CellConstraints.DEFAULT));
		tFloorNumber = new JTextField();
		tFloorNumber.setEditable(false);
		panel1.add(tFloorNumber, cc.xy(3, 23, CellConstraints.FILL, CellConstraints.DEFAULT));
		tCpeb = new JTextField();
		tCpeb.setEditable(false);
		panel1.add(tCpeb, cc.xy(3, 25, CellConstraints.FILL, CellConstraints.DEFAULT));
		final JLabel label12 = new JLabel();
		label12.setText("Type");
		panel1.add(label12, cc.xy(1, 7));
		tBienType = new JTextField();
		tBienType.setEditable(false);
		panel1.add(tBienType, cc.xy(3, 7, CellConstraints.FILL, CellConstraints.DEFAULT));
		final JLabel label13 = new JLabel();
		label13.setText("Acheteur potentiel");
		panel1.add(label13, cc.xy(1, 3));
		tBuyer = new JTextField();
		tBuyer.setEditable(false);
		panel1.add(tBuyer, cc.xy(3, 3, CellConstraints.FILL, CellConstraints.DEFAULT));
