...
public class OfferBuyerDialogWindow extends JDialog implements IBuyerBusinessWindow {
	protected JPanel contentPane;
	protected JButton buttonOK;
	protected JButton buttonCancel;
	protected JTextPane tBien;
	protected JTextField tBuyer;
	protected JTextField tOffer;
	protected JTextField tOwner;

	private boolean validate = false;

	public OfferBuyerDialogWindow() {
		initComponents();
	}

	public OfferBuyerDialogWindow(Offer offer) {
		initComponents();
...
// DO NOT EDIT OR ADD ANY CODE HERE!
	...
	private void $$$setupUI$$$() {
		...
		panel4.setLayout(new FormLayout("fill:d:grow", "center:226px:grow"));
		panel3.add(panel4, new GridConstraints(7, 0, 1, 1, GridConstraints.ANCHOR_CENTER, GridConstraints.FILL_BOTH, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, GridConstraints.SIZEPOLICY_CAN_SHRINK | GridConstraints.SIZEPOLICY_CAN_GROW, null, new Dimension(0, 123), null, 0, false));
		final JScrollPane scrollPane1 = new JScrollPane();
		CellConstraints cc = new CellConstraints();
		panel4.add(scrollPane1, cc.xy(1, 1, CellConstraints.FILL, CellConstraints.FILL));
		tBien = new JTextPane();
		tBien.setEditable(false);
		scrollPane1.setViewportView(tBien);
		tBuyer = new JTextField();
		tBuyer.setEditable(false);
		panel3.add(tBuyer, new GridConstraints(1, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
		...
		label1.setText("Offre");
		panel5.add(label1, new GridConstraints(0, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		tOffer = new JTextField();
		tOffer.setEditable(false);
		panel3.add(tOffer, new GridConstraints(5, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
		...
		panel3.add(tOwner, new GridConstraints(3, 0, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, new Dimension(150, -1), null, 0, false));
